...
class FileTools:
    ...
    @staticmethod
    def list_recordings(group,modality="anat"):
        ...
        for subject_id in subject_list:
            ...
            for session in session_list:
                if "ses-" in session:
                    ...
                    mri_dir_path = join(bidsdir,subject_id,session,modality)
                    if os.path.exists(mri_dir_path):
                        n_mri = len(os.listdir(mri_dir_path))
                        if n_mri!=0:
